...
<body style="margin:0;padding:0;background:#F4F7F9;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 24px;">
    <div style="text-align:center;margin-bottom:40px;">
      <h1 style="font-size:32px;font-weight:700;color:#1C2B33;margin:0 0 8px;">What You Uncovered</h1>
      <p style="font-size:15px;color:#3D5561;margin:0;">Your results from Uncover — saved for you.</p>
    </div>

    ${layersHTML}

    <div style="background:#EBF0F4;border-radius:12px;padding:32px 24px;text-align:center;margin-top:40px;">
      <p style="font-size:16px;color:#3D5561;line-height:1.6;margin:0 0 16px;">What you uncovered matters. Share it with one person this week.</p>
      <a href="https://frontiercommons.org#community" style="display:inline-block;padding:12px 28px;background:#4A8B7F;color:white;text-decoration:none;border-radius:999px;font-size:14px;font-weight:500;">Find Community</a>
    </div>

    <div style="text-align:center;margin-top:40px;padding-top:20px;border-top:1px solid #D6DFE4;">
      <p style="font-size:11px;color:#7A909A;margin:0;">Built by <a href="https://frontiercommons.org" style="color:#7A909A;">Frontier Commons</a></p>
    </div>
  </div>
</body>
</html>`;
